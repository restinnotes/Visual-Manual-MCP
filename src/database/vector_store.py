...
class VectorStore:
    ...
    def _init_table(self):
        ...
        schema = pa.schema([
            ...
            pa.field("relations", pa.string()),  # Stored as JSON string for flexibility
            pa.field("raptor_level", pa.int32()),
        ...
        for r in results:
            try:
                entries.append(MemoryEntry(
                    ...
                    relations=json.loads(r["relations"]) if r.get("relations") else [],
                    raptor_level=r.get("raptor_level", 0),
    ...
    def add_entries(self, entries: List[MemoryEntry]):
        ...
        for entry, vector in zip(entries, vectors):
            data.append({
                ...
                "relations": json.dumps(entry.relations, ensure_ascii=False),
                "raptor_level": entry.raptor_level,
